...
## Two branches are the two environments
...
## Stage 1 — CI must pass before merge
...
## Stage 2 — merge to `main` builds and deploys sandbox
...
### Every image is tagged twice, pushed to two registries
...
### GitOps: the deploy is a commit to `omegaup/prod`
...
## Scheduled promotion to production
...
## Backend services release on their own cadence

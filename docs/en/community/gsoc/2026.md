...
## Query Optimization and Performance Benchmarking {#query-optimization-and-performance-benchmarking}
...
## Performance Monitoring and Alerting Dashboard {#performance-monitoring-and-alerting-dashboard}
...
## Migrating from Vue 2 to Vue 3 {#migrating-from-vue-2-to-vue-3}
...
## Migrating Bootstrap 4 to 5 {#migrating-bootstrap-4-to-5}
...
## Cronjob Optimization {#cronjob-optimization}
...
## Integrate Problem Creator {#integrate-problem-creator}
...
If you are interested spending this summer collaborating with us, first of all, we're honored that you are interested in our organization and we want to make the application process as smooth and enjoyable as possible for you. In order to familiarize yourself with [omegaUp.com](https://omegaup.com) and start collaborating with us please follow these steps:
 ...
 - Read our [technical documentation](../../index.md) on this site (and the [omegaUp repository](https://github.com/omegaup/omegaup) for source code).

# Application Process {#application-process}

#### Our application process consists of three phases. If you want to participate with us this year, you must complete each of them in order. {#our-application-process-consists-of-three-phases-if-you-want-to-participate-with-us-this-year-you-must-complete-each-of-them-in-order}
...
#### note: alternative url for the test: [omegaUp Test](https://omegaup.com/arena/gsoc2026) {#note-alternative-url-for-the-test-omegaup-test}
...
We ask that you complete phase one before you start working with our codebase.
 ...
 - Follow the [development environment setup](../../getting-started/development-setup.md) guide.
...
### Phase Four: Interview with the organization {#phase-four-interview-with-the-organization}
...
# Communications {#communications}
## If you have questions about the [development environment](../../getting-started/development-setup.md), the [codebase](https://github.com/omegaup/omegaup), or how the GSoC application process works at omegaUp, please follow our [getting help](../../getting-started/getting-help.md) guide so your question gets answered efficiently. {#if-you-have-questions-about-the-development-environment-the-codebase-or-how-the-gsoc-application-process-works-at-omegaup-please-follow-our-getting-help-guide-so-your-question-gets-answered-efficiently}
...
# Frequently Asked Questions # {#frequently-asked-questions}
   * **The development environment installation script is throwing me an error.** Please follow our [getting help](../../getting-started/getting-help.md) guide to get your issue resolved.

...
!!! info "Idioma"
    O texto principal está em **inglês**, alinhado às propostas e à documentação técnica do GSoC. A equipe também responde em português no [Discord](https://discord.gg/gMEMX7Mrwe).
